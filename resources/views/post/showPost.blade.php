...
@section('content')     
    ...
    <div id="successAlert_editPost" class="transition-opacity duration-500 ease-in-out mt-4 w-full max-w-4xl bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mx-auto" role="alert">
            <strong class="font-bold">¡Éxito!</strong>
            <span class="block sm:inline">{{ session('edit_post') }}</span>
    ...
    @elseif(session('error_editpost'))
    <div id="errorAlert_editPost" class="transition-opacity duration-500 ease-in-out mt-4 w-full max-w-4xl bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mx-auto" role="alert">
            <strong class="font-bold">¡Error!</strong>
            <span class="block sm:inline">{{ session('error_editpost') }}</span>
            <span class="absolute top-0 bottom-0 right-0 px-4 py-3 ml-4">
